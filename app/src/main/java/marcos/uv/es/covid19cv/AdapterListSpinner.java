...
public class AdapterListSpinner extends ArrayAdapter<SymtomModel> {
    private ArrayList<SymtomModel> listState;
    private AdapterListSpinner myAdapter;
    private Context mContext;
    private boolean isFromView = false;

    public AdapterListSpinner(Context context, int resource, List<SymtomModel> objects) {
        super(context, resource, objects);
        this.mContext = context;
        this.listState = (ArrayList<SymtomModel>) objects;
        this.myAdapter = this;
    }
